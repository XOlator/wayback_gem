...
describe Wayback::Client do
  ...
  #   stub_get("/1.1/account/verify_credentials.json").to_return(:body => fixture("gleuch.json"), :headers => {:content_type => "application/json; charset=utf-8"})
  #   client1 = Wayback::Client.new
  ...
  #     client = Wayback::Client.new(:consumer_key => 'CK', :consumer_secret => 'CS', :oauth_token => 'OT', :oauth_token_secret => 'OS')
  #     expect(client.credentials?).to be_true
  #   end
  #   it "returns false if any credentials are missing" do
  #     client = Wayback::Client.new(:consumer_key => 'CK', :consumer_secret => 'CS', :oauth_token => 'OT')
  ...
  #     expect{subject.send(:request, :get, "/path")}.to raise_error Wayback::Error::DecodeError
  #   end
  # end
  # 
